...
class NewRestaurentTableCell: UITableViewCell {
    
    // MARK: - IBoutlets
    @IBOutlet weak var collectionRestaurent: UICollectionView!
    @IBOutlet weak var newRestaurantLbl: UILabel! {
        didSet {
            newRestaurantLbl.font = AppFont.bold(size: 18)
        }
    }
    // MARK: - Variables
    fileprivate var width: Float = 0.00
    fileprivate var isGridSelected = true
        ...
        didSet {
            ...
            if isDarkMode == true {
               self.collectionRestaurent.backgroundColor = #colorLiteral(red: 0.1260324419, green: 0.1292469203, blue: 0.1336024106, alpha: 1)
                ...
                newRestaurantLbl.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
            } else {
                ...
                newRestaurantLbl.textColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
            }
            
            newRestaurantLbl.text = "Explore new restaurants".localizedString
            restaurantList = data
...
extension NewRestaurentTableCell: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if isGridSelected == true {
            ...
            if let imageUrl = cell.restaurantData?.restaurantImageURL {
                cell.backImage.imageUrl(imageUrl: imageUrl, placeholderImage: #imageLiteral(resourceName: "ic_placeholderBg"))
            }
...
extension NewRestaurentTableCell: UICollectionViewDelegateFlowLayout {
